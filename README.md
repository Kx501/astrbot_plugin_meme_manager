...
2. 如果需要修改表情包以及对应的llm提示, 查看`data/plugin_data/meme_manager`目录下的结构, `memes_data.json`即对应的文件夹分类和描述的映射关系, `memes`目录下的文件夹名称即分类名称, 里面的图片即对应类别的表情包, 你可以新建一个类别的文件夹, 并在json文件中添加对应的描述来添加新的表情类别, 也可以直接往自带的表情包中添加新的表情(上传文件到对应目录即可)
...
1. **打开设置**：进入设置界面，如图所示：
   ![打开设置](https://raw.githubusercontent.com/Kx501/picx-images-hosting/master/astrbot_plugin_meme_manager/.github/img/open_setting.png)

2. **进行设置**：根据以下说明进行配置，你也可以点击问号了解配置说明：
   ![设置插件](https://raw.githubusercontent.com/Kx501/picx-images-hosting/master/astrbot_plugin_meme_manager/.github/img/setting.png)
...
2. **建立空间**：注册账号后，你需要先建立一个空间，操作如图所示：
   ![建立空间](https://raw.githubusercontent.com/Kx501/picx-images-hosting/master/astrbot_plugin_meme_manager/.github/img/stardots_step2.png)

   > 记住你建立的空间的名字，将其填入插件设置中的图床配置信息的空间名称中。

3. **获取 API Key 和 API Secret**：在同样的界面，点击左侧的"开放 API" -> "密钥"，点击生成密钥：
   ![生成密钥](https://raw.githubusercontent.com/Kx501/picx-images-hosting/master/astrbot_plugin_meme_manager/.github/img/stardots_step3.png)

   你会看到如下画面：
   ![获得密钥](https://raw.githubusercontent.com/Kx501/picx-images-hosting/master/astrbot_plugin_meme_manager/.github/img/stardots_step4.png)
...
| 功能           | 预览图示                                                      |
| -------------- | ------------------------------------------------------------- |
| 登录界面       | ![登录界面](https://raw.githubusercontent.com/Kx501/picx-images-hosting/master/astrbot_plugin_meme_manager/.github/img/login_screenshot.png)                 |
| 表情包管理界面 | ![表情包管理界面](https://raw.githubusercontent.com/Kx501/picx-images-hosting/master/astrbot_plugin_meme_manager/.github/img/meme_management_screenshot.png) |
